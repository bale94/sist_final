		...
		<div class="layout-container">
			...
			<aside id="layout-menu"
				...
				<ul class="menu-inner py-1">
					...
					<!-- 전체 업무 -->
					<li class="menu-item"><a href="${path}/allSchedule.do"
						class="menu-link"> <i class="menu-icon tf-icons bx bx-detail"></i>
					...
					<li class="menu-item active"><a href="${path}/RM.do"
					...
					<li class="menu-item"><a href="${path}/teamChat.do"
						class="menu-link"> <i class="menu-icon tf-icons bx bx-chat"></i>
							<div data-i18n="팀 채팅">팀 채팅</div>
					</a></li>
					<li class="menu-item"><a href="${path}/directMessage.do"
						class="menu-link"> <i class="menu-icon tf-icons bx bx-message"></i>
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">리스크관리 /</span> 리스크 게시물 상세 <br>
						</h4>	
						<a>[${memName }]님</a>
						<div class="card">
							...
							<div class="container-xxl flex-grow-1 container-p-y">
								...
								<form id="frm01" action="${path}/RMUpdate.do" class="form"
									method="post" >
									<input type="hidden" name="RM_no" value="${proc.RM_no}"
										class="from-control" />
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span style="width: 120px;"
												class="text-center input-group-text">프로젝트이름</span>
										</div>
										<input style="width: 50%;" name="pname" class="from-control"
											value="${proc.pname }" readonly /><br>
									</div>
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span style="width: 120px;"
												class="text-center input-group-text">업무이름</span>
										</div>
										<input style="width: 50%;" name="tname" class="from-control"
											value="${proc.tname }" readonly />
									</div>
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span style="width: 120px;"
												class="text-center input-group-text">작성자</span>
										</div>
										<input name="name" class="from-control" value="${proc.name }"
											readonly />
									</div>
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span style="width: 120px;"
												class="text-center input-group-text">작성일</span>
										</div>
										<%--
									<input type="date" name="name" class="from-control" value="${proc.writeDates}"
										placeholder="${proc.writeDates}"/> --%>
										<%--<fmt:formatDate pattern="yyyy-MM-dd" value="${proc.writeDate}" />  --%>
										<input readonly type="date" name="writeDates" class="form-control"
											value='<fmt:formatDate value="${proc.writeDate}" 
									pattern="yyyy-MM-dd"/>' />
									</div>
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span style="width: 120px;"
												class="text-center input-group-text">마감일</span>
										</div>
										<%--<input type="date" name="name" class="from-control" value="${proc.edates}"
										placeholder="${proc.edates}"/>--%>
										<%--<fmt:formatDate pattern="yyyy-MM-dd" value="${proc.edate}" /> --%>
										<input readonly type="date" id="edates" name="edates" class="form-control"
											value='<fmt:formatDate value="${proc.edate}" 
									pattern="yyyy-MM-dd"/>' />
									</div>
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span style="width: 120px;"
												class="text-center input-group-text">중요도</span>
										</div>
										<select name="importance">
											<option>${proc.importance}</option>
									...
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span style="width: 120px;"
												class="text-center input-group-text" >진행단계</span>
										</div>
										<select name="progress">
											<option>${proc.progress }</option>
											<option disabled>====</option>
											<option>검토</option>
											<option>진행</option>
											<option>완료</option>
									...
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span style="width: 120px;"
												class="text-center input-group-text">이슈사항</span>
										</div>
										<textarea cols="100" name="issue" rows="10"
											class="from-control" readonly>${proc.issue }</textarea>
									</div>
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span style="width: 120px;"
												class="text-center input-group-text">이슈해결방안</span>
										</div>
										<textarea cols="100" name="solution" rows="10" maxlength="666"
											class="from-control">${proc.solution }</textarea>
									</div>
									<div class="text-right">
										<button type="button" onclick="updateProc()"
											class="btn btn-success ">수정</button>
										<button type="button" onclick="deleteProc()"
											class="btn btn-danger">삭제</button>
										<button type="button" class="btn btn-primary btn-goRM01"
											onclick="goRM01()">취소</button>
									</div>
								</form>
							</div>
						</div>
