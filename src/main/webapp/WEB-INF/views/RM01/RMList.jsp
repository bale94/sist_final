				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">리스크관리 /</span> 리스크 게시판
						</h4>
						<a>[${memName }]님</a>
						<div class="card">
						<form id="frm01" class="form"  method="post">
						<div class="divgrey">
						<div class="" style="widhth:50%;">
								<input type="hidden" name="curPage" value="0" />
								<button type="button" class="btn btn-primary btn-goInsert"
									onclick="goRMInsert()" >게시물 등록</button>
						</div>
						<div class="lb-3" style="widhth:50%;">
							...
							<script type="text/javascript">
								$("[name=pageSize]").val("${RMSch.pageSize}");
						...
						<table class="table table-hover table-striped ">
							...
							<thead>
								<tr class="text-center tablehead">
									<th style="color: white;">리스크번호</th>
									<th style="color: white;">프로젝트이름</th>
									<th style="color: white;">업무이름</th>
									<th style="color: white;">작성자</th>
									<th style="color: white;">이슈사항</th>
									<th style="color: white;">중요도</th>
									<th style="color: white;">진행단계</th>
								</tr>
							</thead>
							<tbody class="text-center">
								<c:forEach var="r" items="${rmlist}">
									<tr ondblclick="goRMUpdate(${r.RM_no})">
										<td>${r.RM_no}</td>
										<td>${r.pname}</td>
										<td>${r.tname}</td>
										<td>${r.name}</td>
						...
						<ul class="pagination justify-content-end">
							<li class="page-item">
							<a class="page-link" href="javascript:goPage(${RMSch.startBlock-1 })">Previous</a></li>
							<c:forEach var="cnt" begin="${RMSch.startBlock }" end="${RMSch.endBlock }">
								<li class="page-item ${RMSch.curPage==cnt?'active':''}">
									<a class="page-link" href="javascript:goPage(${cnt})">${cnt}</a>
								</li>
							</c:forEach>
							<li class="page-item">
							<a class="page-link" href="javascript:goPage(${RMSch.endBlock+1 })">Next</a></li>
						</ul>
						<script type="text/javascript">
							function goRMInsert() {
								location.href = "${path}/RMInsertForm.do"
							}
							function goRMUpdate(RM_no) {
								location.href = "${path}/RMUpdate.do?RM_no="
										+ RM_no;
							}
							function goPage(cnt) {
