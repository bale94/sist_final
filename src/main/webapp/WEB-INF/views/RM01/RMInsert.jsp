				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">리스크관리 /</span> 리스크 게시물 등록
						</h4>
						<a>[${memName }]님</a>
						<div class="card">
						<script type="text/javascript">
							...
							function insertProc() {
								if (confirm("등록하시겠습니까?")) {
									...
									var edateVal = $("[name=edates]").val();
									if (edateVal == "") {
										alert("마감일을 입력하세요");
										$("[name=edates]").focus();
										return;
									}
									var issueVal = $("[name=issue]").val();
									if (issueVal == "") {
										alert("이슈사항을 입력하세요");
										$("[name=issue]").focus();
										return;
							...
							window.onload = function() {
								...
								writeDates = document.getElementById("writeDates");
								writeDates.value = today;
						...
						<div class="container-xxl flex-grow-1 container-p-y">
							<form id="frm01" action="${path}/RMInsert.do" class="form"
								method="post" >
								<input type="hidden" name="progress" class="from-control"
									value="검토" /> <input type="hidden" name="solution"
								...
								<div class="input-group mb-3">
									...
									<input name="pname" class="form-control" value="" maxlength="33"
								...
								<div class="input-group mb-3">
									...
									<input name="tname" class="form-control" value="" maxlength="33"
										placeholder="업무이름을 입력하세요" /><br>
								</div>
								<div class="input-group mb-3">
									<div class="input-group-prepend">
										<span style="width: 120px;"
									...
									<input name="name" class="form-control" value="${memName }" maxlength="13" readonly />
								</div>
								<div class="input-group mb-3">
									<div class="input-group-prepend">
										<span style="width: 120px;"
									...
									<input type="date" name="writeDates" id="writeDates" class="form-control"
										readonly /><br> 
								</div>
								<div class="input-group mb-3">
									<div class="input-group-prepend">
									...
									<input type="date" id="edates"  name="edates" class="form-control" value="" min="2022-08-23"  /><br>
								</div>
								...
								<div class="input-group mb-3">
									...
									<textarea cols="100" name="issue" rows="10" maxlength="66"
										class="from-control" placeholder="이슈사항을 입력하세요"></textarea>
									<br>
								</div>

								<div class="text-right">
									<button type="button" class="btn btn-primary btn-newInsert"
										onclick="insertProc()">게시물 등록</button>
