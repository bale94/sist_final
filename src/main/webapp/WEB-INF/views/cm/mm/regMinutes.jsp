...
>
  ...
  <body>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">의사소통관리 /</span> 회의록 등록</h4>
              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="${path}/regMinutes.do" method="post">
                      ...
                      <div class="row gy-3 mb-3">
	                        <div class="col-md">
	                        	...
	                        	<input type="text" class="form-control" id="basic-default-attendees"
	                        		   name="attendees"/>			                	
	                        </div>
                      </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <textarea class="form-control" 
                                    id="basic-default-contents" 
                          			rows="10" cols="120" name="contents"></textarea>
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-decision">결정사항</label>
                          <textarea class="form-control" 
                          			id="basic-default-decision" 
                          			rows="10" cols="120" name="decision"></textarea>
                        </div>
                        <button type="button" class="btn btn-outline-primary" onclick="reg()">등록</button>
                      </form>
                    </div>
                  </div>
                </div>
    ...
    <script type="text/javascript">
	    ...
	    function reg(){
			if(confirm("등록하시겠습니까?")){
				var mdateVal = $("[name=mdateS]").val();
				if( mdateVal == "" ){
					alert("회의일시를 선택하세요");
					$("[name=mdateS]").focus();
					return;
				}
				var wdateVal = $("[name=wdateS]").val();
				if( wdateVal == "" ){
					alert("작성일자를 선택하세요");
					$("[name=wdateS]").focus();
					return;
				}
				var attVal = $("[name=attendees]").val();
				if( attVal == "" ){
					alert("참석자를 입력하세요");
				...
				var decisionVal = $("[name=decision]").val();
				if( decisionVal == "" ){
					alert("결정사항을 입력하세요");
					$("[name=decision]").focus();
					return;
