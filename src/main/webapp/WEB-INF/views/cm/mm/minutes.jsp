        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- Meeting Minutes of in progress -->
              <h5 class="pb-1 mb-4">진행중인 회의록</h5>
               
              <c:forEach var="prj" items="${prjList}">
              <div class="row mb-3" onclick="goMM(${prj.project_no})">
                <div class="col-md">
                  <div class="card mb-3">
                    <div class="row g-0">
                      <div class="col-md-5" id="prj-title">
                          <h5 class="card-title">${prj.pname}</h5>
                      </div>
                      <div class="col-md-3">
                        <div class="card-body">
                          <p class="card-text">${prj.content}</p>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="card-body" style="text-align: right;">
                          <p class="card-text">
                          	...
                          	<span class="badge rounded-pill bg-primary"  style="margin-left: 2rem;">
                          	${prj.progress}%
                          	</span>
                          </p>
                        </div>
