      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
             <!-- Dashboard -->
            <li class="menu-item">
              <a href="${path}/DS.do" class="menu-link">
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">pm이 등록사원에게 메일발송</p>

              <form id="formAuthentication" class="mb-3" action="${path}/mailSender.do" method="POST">
                <div class="mb-3">
               ...
               <div class="mb-3">
                  <button class="btn btn-primary d-grid " type="submit">메일발송</button>
                </div>
