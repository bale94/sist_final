...
>
 ...
 <script type="text/javascript">
	...
	if(empno != null && empno.value!=null){
		if(empno.value==""){
			alert(" 사원번호를 입력해주세요")
			empno.focus();
			return;
		  }else if(empno.value.length>10 || isNaN(empno.value) ){
			alert("사원번호는 발급된 숫자10자리 형식으로 입력가능합니다") 
			empno.focus()
			return;
		}
		else{
			...
			if(pass.value!=null){//비밀번호 유효성검사
				if(pass.value==""){
					...
					document.querySelector("#formAuthentication").submit();
					}
				}
	 ...
	 //유효성 체크 완료후 login2.do을 통해 사원번호와 비밀번호가 맞는지 체크
	 if(login2=="N"){
			alert(" 사원번호 혹은 비밀번호가 틀렸습니다.");
			location.href= "login.do";
		}else if(login2=="Y"){
			location.href= "goDS.do";
		}		
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" hidden="">
          <div class="app-brand demo" hidden="">
            <a href="${path}/login.do" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2" hidden="">4pro</span>
            </a>

            <a href="javascript:void(0);" class="layout-menu-toggle menu-link text-large ms-auto d-block d-xl-none" hidden="">
              <i class="bx bx-chevron-left bx-sm align-middle" hidden=""></i>
            </a>
          </div>
          ...
          <ul class="menu-inner py-1" hidden="">
            ...
            <li class="menu-item">
              ...
              <a href="${path}/join.do" class="menu-link">
               ...
               <li class="menu-item ">
              <a href="${path}/mailFrom.do" class="menu-link">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="사원정보메일발송">사원정보메일발송</div>
              </a>
              </li>
        ...
        <!-- Layout container -->
        <div class="layout-page" style="padding-left:30%;padding-right:30%;margin-top:10%;">
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">4pro</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to 4pro! 👋</h4>
              <p class="mb-4">사원번호와 비밀번호를 입력해주세요!!</p>

              <form id="formAuthentication" class="mb-3" action="${path}/login2.do" method="POST">
                <div class="mb-3">
                  <label for="id" class="form-label">사원번호</label>
                  <input
                    value="${param.empno}"
                    type="text"
                    class="form-control"
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" onclick="canLog()" type="button">로그인</button>
                </div>
              </form>
...
<!-- 여기 
	...
	<form id="frm01" action="${path}/login2.do" class="form"  method="post">
		<input name="id"  type="text" 
			class="container-xxl flex-grow-1 container-p-y" placeholder="아이디 입력" />
	    <input name="pass" type="password" 
	    	class="container-xxl flex-grow-1 container-p-y" placeholder="비밀번호 입력" />
