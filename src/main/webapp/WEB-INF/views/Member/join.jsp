...
<div class="container-xxl">
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">사원등록</h4>
              <p class="mb-4">새로운 사원의 이름과 이메일을 입력해주세요.</p>

              <form id="formAuthentication" class="mb-3" action="${path}/join2.do"
              			 method="POST">
                <div class="mb-3">
                  ...
                  <div class="input-group input-group-merge">
                    <input
                      ...
                      value=""
                      class="form-control"
                      name="email" placeholder="메일주소를 입력해주세요. ex)abc@naver.com" required
                    />
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" onclick="insert()" 
                  type="button">사원등록</button>
    ...
    <!-- / Content -->					         	
	    ...
	    <!--
	    <form id="frm01" action="${path}/join2.do" class="form"  method="post">
		<input name="name"  type="text"  value="${param.name}"
			class="container-xxl flex-grow-1 container-p-y" placeholder="이름 입력" />
	    <input name="email" type="text"  value="${param.email}"
	    	class="container-xxl flex-grow-1 container-p-y" placeholder="이메일 입력" />
	    	<button class="btn btn-info" type="submit">사원등록</button>     
	    	<input type="button" onclick="insert()" value="사원등록">&nbsp;
	     -->
	    </form>     	
    ...
    <script type="text/javascript">
	    $(document).ready(function(){
			...
			if(isInsert=="Y") alert("4pro사원등록 성공")
