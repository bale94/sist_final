        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
            	<div class="row">
		        	<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">인적자원관리 /</span> 개인정보수정</h4>
		        	<h5>${member.name}님 정보수정 페이지</h5>
		        	<div class="card">
		        		<form action="${path}/hresUptInfo.do" method="get"><br><br>
			        	<input type="hidden" name="empno" value="${empno}">
				       		<div class="card-body input-group mb-1">
					        	<div class="input-group-prepend">
					            	<span class="text-center input-group-text" id="input-group-left-example">이름</span>
					         	</div>
					         	<input name="name" class="form-control" aria-describedby="input-group-left"
					            	value="${member.name }" readonly />   
							</div> 
				       		<div class="card-body input-group mb-1">
					        	<div class="input-group-prepend">
					            	<span class="text-center input-group-text" id="input-group-left-example">이메일</span>
					         	</div>
					         	<input name="email" class="form-control" aria-describedby="input-group-left"
					            	value="${member.email }" readonly />   
							</div>
							<div class="card-body input-group mb-1">
					        	<div class="input-group-prepend">
					            	<span class="text-center input-group-text" id="input-group-left-example">비밀번호</span>
					         	</div>
					         	<input type="password" name="pass" class="form-control" aria-describedby="input-group-left"
					            	value="${member.pass }"/>   
							</div>
							<div class="card-body input-group mb-1">
								<div class="input-group-prepend">
					            	<span class="text-center input-group-text" id="input-group-left-example">비밀번호 확인</span>
					         	</div>
					         	<input type="password" name="passck" class="form-control" aria-describedby="input-group-left"
					            	placeholder="비밀번호를 확인해주세요" value=""/> 
							</div>
							<br>
							<div class="card-body text-right">
							<button type="button" id="uptBtn" onclick="updateProc()" class="btn btn-primary float-end">수정</button>
						</div>
			        	</form>
		        	</div>
		        </div>
    ...
    <script type="text/javascript">
    	function updateProc(){
    		if(confirm("수정하시겠습니까?")){
    			...
    			$("form").attr("action","${path}/hresUptInfo.do");
    			$("form").submit();	
    		}
		}
    	var proc = "${proc}";
    	if(proc=="upt"){
    		if(confirm("수정이 완료되었습니다.")){
    			location.href="${path}/hresInfo.do?empno=${empno}";
    		}
    	}
    </script>
    <script type="text/javascript">
