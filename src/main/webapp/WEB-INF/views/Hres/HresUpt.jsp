        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
			...
			<div class="container-xxl flex-grow-1 container-p-y">
				<div class="row">
					<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">인적자원관리 / 사원정보조회 /</span> 사원권한수정</h4>
					<div class="card">
						<form id="frm01" class="form" name="form"  method="post" >
						<br><br>
							<input type="hidden" name="empno" value="${member.empno}">
							<div class="input-group mb-3">
					        	<div class="input-group-prepend">
					            	<span class="text-center input-group-text" id="input-group-left-example">사원명</span>
					         	</div>
							...
							<div class="input-group mb-3">
					         	<select aria-label="large select" name="auth" class="form-select form-select-lg">  
					         		<option value="${member.auth}">현재권한: ${member.auth}</option>
							...
							<div class="text-right">
								<button type="button" onclick="updateProc()" class="btn btn-success float-end">수정</button>
							</div>
						</form> 
					</div>
				</div>
...
<script type="text/javascript">
	function updateProc(){
		if(confirm("수정하시겠습니까?")){
			$("form").attr("action","${path}/hresUptAuth.do");
			$("form").submit();
		}
	}
	var proc = "${proc}"
	if(proc == "upt"){
		if(confirm("수정되었습니다.\n리스트화면으로 이동하시겠습니까?")){
			location.href="${path}/hresList.do";
		}
	}
</script>
</html>
