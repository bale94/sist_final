...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="${path}/resources/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <p class="mb-4 mx-2">해당 권한으로는 접근이 불가능합니다.</p>
        <a href="${path}/goDS.do" class="btn btn-primary">홈으로</a>
        <div class="mt-4">
          <img
            src="${path}/resources/assets/img/illustrations/girl-doing-yoga-light.png"
