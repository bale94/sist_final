...
<div class="jumbotron text-center">
	...
	<!-- name="form" InsertPM.do -->
	<div class="container">
		<div class="card">
			<form id="frm01" enctype="multipart/form-data" action="${path}/InsertPM.do" 
		 class="form"  method="post"style="border: solid;">
		
		<!--<input type="hidden" name="no" value="${empty pmboard.cnt?'0': pmboard.cnt}"/>  -->	
		  <input type="hidden" name="project_no" value="${empty param.project_no?'0': param.project_no}"/>
			...
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					<span class="text-center input-group-text"><a style=color:red;>*</a>프로젝트 명:</span>
				</div>
				<input name="pname" class="form-control" value="${param.pname}"
					placeholder="프로젝트 제목을 입력하세요" />
			</div>
			
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					<span class="text-center input-group-text"><a style=color:red;>*</a>작성자 :</span>
				</div>
				<input name="name" class="form-control" value="${param.name}"
...
<div class="input-group mb-3">
				...
				<input name="writer" class="form-control" value="${pmboard.writer}"
					placeholder="작성자 입력하세요" />
			</div>
 -->
 <nav class="navbar navbar-expand-sm">
			<div class="input-group-prepend">
				<span class="text-center input-group-text">권한:</span>
			</div>
			...
			<nav class="navbar navbar-expand-sm">
			<div class="input-group-prepend">
				<span class="text-center input-group-text">진행도:</span>
			</div>
			<div class="custom-select" style="width:200px;">
			...
			<div class="input-group mb-3">
			 ...
			 -->
						<div class="input-group mb-3">
				<div class="input-group-prepend">
					<span class="text-center input-group-text"><a style=color:red;>*</a>내 용</span>
				</div>
 ...
 -->
     <div class="input-group mb-3">
			...
			<div class="text-right">
				<button type="button" onclick="insertProc()" class="btn btn-outline-success">등록</button>
				<button type="button" onclick="goMain()" class="btn btn-outline-info">메인화면</button>
			</div>
		</form>
	</div>
</div>
	<script type="text/javascript">
		...
		function insertProc() {
			if (confirm("등록하시겠습니까?")) {
				...
				var writerVal = $("[name=content]").val();
				if (writerVal == "") {
					alert("내용을 등록하세요");
					$("[name=content]").focus();
					return; // 프로세스를 중단 처리
