	...
	<div class="card">
		...
		<div class="input-group mb-3">
				...
				<input name="pname" class="form-control" value="${pmboard.pname}"
					placeholder="프로젝트 제목을 입력하세요" readonly/>
			</div>
...
<nav class="navbar navbar-expand-sm">
			...
			<div class="input-group mb-3">
			<div class="input-group-prepend" >
				<span class="text-center input-group-text" >작성자권한 :</span>
			</div>
			...
			<div class="input-group mb-3">
			<div class="input-group-prepend" >
				<span class="text-center input-group-text" >프로젝트 유형:</span>
			</div>
			...
			<div class="input-group mb-3">
				...
				<textarea name="content" rows="5" class="form-control"
					placeholder="내용 입력하세요" readonly>${pmboard.content}</textarea>
			</div>
