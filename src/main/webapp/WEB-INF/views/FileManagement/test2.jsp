      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="${path}/teamChat.do" class="menu-link" onclick="goTC()">
            ...
            <li class="menu-item">
              <a href="${path}/directMessage.do" target="_blank" class="menu-link">
                ...
                <div data-i18n="개인 채팅">개인 채팅</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="${path}/minutes.do" target="_blank" class="menu-link">
...
<div class="plogo">Project Manager</div>
...
<%--
 ...
 --%>
		...
		<div class="input-group-prepend">
			<span class="text-center input-group-text">총 : ${PMBoardSch.count }건</span>
		</div>
	...
	<script type="text/javascript">
		...
		<form>
		<input type="button" value="추가" onclick="openWin()">
		</form>
