...
<html>
  <head>
  	<style type="text/css">
  	.area-wrapper{ /* area div 두 개를 묶은 div */
  	display: flex;
  	
  	}
  	#area{ /* 좌 ds, 우 ds 두 개로 묶은 div */
  	width: 50%; /* 좌, 우 50%씩 할당. 고정 */
  	height: 100%;
	...
	width: 100%;
	height: 630px; /* 높이 설정  500px;*/
	 /* padding-bottom: 10%;   16:9 비율 */
	}
	
	#ds2{ /* iframe 개개인 */
	/*position: relative;  absolute는 부모가 relative일 때 부모를 따라간다. */
	width: 100%;
	height: 350px; /* 높이 설정  500px;*/
	 /* padding-bottom: 10%;   16:9 비율 */
	}
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <div class="layout-page">
          <!-- Navbar -->
          <nav
            class="layout-navbar container-xxl navbar navbar-expand-x navbar-detached align-items-center bg-navbar-theme" 
            		style=" padding-top : 15px; padding-left: 100px;"	
            		id="layout-navbar">
          	   <!-- 사용자의 권한 표시-->
           <h5>${member.empno} 안녕하세요 ${member.name}[${member.auth}]님!</h5> 
          </nav>
              <div class="container-xxl flex-grow-1 container-p-y">
		<div class="area-wrapper">
		<div id="area" class="content" align="right">
				<iframe  id="ds" src="${path}/calendarDS.do" scrolling ="no"></iframe>		
            		
          </div>
          <div id="area" class="content" align="left">
          		
           		<iframe id="ds" style="margin-top:12px;" src="${path}/allSchedule2.do" ></iframe>
          </div>
          
          </div> 
          <div><iframe id="ds2" src="${path}/ganttDS.do" scrolling ="no"></iframe></div>
          <div><iframe id="ds2" src="${path}/PMdash.do" scrolling ="no"></iframe></div>
          </div>
